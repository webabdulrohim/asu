...
try {
    ...
    $mergeParams = array_merge($params, [$perPage, $offset]);
...
$pageTitle = !empty($search) ? 'Pencarian: ' . $search : 'Semua Produk';
if (!empty($categorySlug)) {
...
<div class="products-page">
    ...
    <nav aria-label="breadcrumb" style="margin-bottom: 20px;">
        <ol class="breadcrumb" style="display: flex; gap: 8px; list-style: none; padding: 0; margin: 0;">
            ...
            <li>/</li>
            <li style="color: #666;"><?= htmlspecialchars($pageTitle) ?></li>
        </ol>
    </nav>

    <!-- Page Header -->
    <div class="page-header">
        <h1><i class="fas fa-gem"></i> <?= htmlspecialchars($pageTitle) ?></h1>
        <?php if (!empty($search)): ?>
            <p>Hasil pencarian untuk "<?= htmlspecialchars($search) ?>"</p>
        <?php endif; ?>
    </div>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <p>Coba dengan kata kunci lain atau ubah filter pencarian.</p>
            <a href="products.php" style="display: inline-block; margin-top: 20px; padding: 12px 30px; background: var(--primary-color); color: white; text-decoration: none; border-radius: 8px;">Lihat Semua Produk</a>
        </div>
    <?php endif; ?>
</div>
